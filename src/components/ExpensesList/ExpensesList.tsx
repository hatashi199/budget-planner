			...
			{expensesData?.length !== 0 ? (
				<div className='flex justify-center w-full py-pad68'>
					<div className='flex flex-col gap-[2.5rem] max-w-[1000px] w-full'>
						<h3 className='text-purpleD dark:text-whiteD text-[2rem]'>
							Gastos
						</h3>
						<div className='flex flex-col gap-[2rem]'>
							{expensesData?.map((expense) => {
								return (
									<div
										key={expense.id}
										className='flex justify-between items-center box-shadow-light dark:box-shadow-dark bg-whiteD dark:bg-purpleD box-shadow-1 rounded-rad12 p-pad24 mx-mar24'
									>
